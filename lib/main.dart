import 'dart:convert';
import 'package:conversor_bitcoins/web_view.dart';
                ...
                if (snapshot.hasError) {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Image.asset('../assets/bit.png', height: 180),
                        SizedBox(
                        ...
                        const Divider(),
                        buildTextFild(Image.asset('assets/brasil.png'), "Reais",
                            "R\$", realConttroler, _realMudou),
                        const Divider(),
                        buildTextFild(Image.asset(''), "Dolar", "UR\$",
                            dolarConttroler, _dolarMudou),
                        const Divider(),
                        buildTextFild(Image.asset(''), "BitCoin", "₿",
                            bitCoinConttroler, _bitCoinMudou),
                        const Divider(),
                        SizedBox(
                          height: 50,
                          child: ElevatedButton(
